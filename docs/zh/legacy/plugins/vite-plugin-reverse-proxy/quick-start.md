...
- 本文档对应插件版本：**vite-plugin-reverse-proxy ≤ 1.x**。
- 适用打包器：Rollup + esbuild。**不支持 Vite 8+ 的 Rolldown 打包器**，Vite 7/8+ 用户请查看最新文档：
  - 中文新文档：<a href="/zh/plugins/vite-plugin-reverse-proxy/quick-start?latest=1">/zh/plugins/vite-plugin-reverse-proxy/quick-start</a>
  - English：<a href="/plugins/vite-plugin-reverse-proxy/quick-start?latest=1">/plugins/vite-plugin-reverse-proxy/quick-start</a>
:::
# vite-plugin-reverse-proxy（旧版）
